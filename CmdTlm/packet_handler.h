...
#define TL_TLM_PAGE_MAX   (8) // PROCYONでは8

#define PH_GS_CMD_LIST_MAX  (8)  // PROCYONでは8
#define PH_RT_CMD_LIST_MAX  (32) // PROCYONでは16
#define PH_TL0_CMD_LIST_MAX (TL_TLM_PAGE_SIZE * TL_TLM_PAGE_MAX)   // コメント追加（2019/08/19）
                                                                   // これが最長じゃないといけない
                                                                   // TLCD_tl_list_for_tlmの長さがこれなので！！
#define PH_TL1_CMD_LIST_MAX (TL_TLM_PAGE_SIZE * 4) // PROCYONではSIZE*2
#define PH_TL2_CMD_LIST_MAX (TL_TLM_PAGE_SIZE * 4) // PROCYONではSIZE*2
