...
typedef enum
{
  ...
  Cmd_CODE_TF_INIT = 0x006A,
  Cmd_CODE_CA_INIT = 0x006B,
  Cmd_CODE_TF_REGISTER_TLM = 0x006C,
  Cmd_CODE_CA_REGISTER_CMD = 0x006D,
  Cmd_CODE_TF_SET_PAGE_FOR_TLM = 0x006E,
  Cmd_CODE_CA_SET_PAGE_FOR_TLM = 0x006F,
