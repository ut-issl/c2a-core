...
typedef enum
{
  ...
  Cmd_CODE_BCT_ACTIVATE_BLOCK = 0x001D,
  Cmd_CODE_BCT_ROTATE_BLOCK = 0x001E,
  Cmd_CODE_BCT_COMBINE_BLOCK = 0x001F,
  Cmd_CODE_BCT_TIMELIMIT_COMBINE_BLOCK = 0x0020,
  Cmd_CODE_BCT_RESET_ROTATOR_INFO = 0x0021,
  Cmd_CODE_BCT_RESET_COMBINER_INFO = 0x0022,
  Cmd_CODE_BCT_SET_ROTATE_INTERVAL = 0x0023,
  Cmd_CODE_BCT_ACTIVATE_BLOCK_BY_ID = 0x0024,
  Cmd_CODE_BCT_INACTIVATE_BLOCK_BY_ID = 0x0025,
  Cmd_CODE_BCT_FILL_NOP = 0x0026,
  Cmd_CODE_BCT_COPY_BCT = 0x0027,
  Cmd_CODE_BCT_OVERWRITE_CMD = 0x0028,
  ...
  Cmd_CODE_EH_ACTIVATE_RULE = 0x005A,
  Cmd_CODE_EH_INACTIVATE_RULE = 0x005B,
  Cmd_CODE_EH_ACTIVATE_RULE_FOR_MULTI_LEVEL = 0x005C,
  Cmd_CODE_EH_INACTIVATE_RULE_FOR_MULTI_LEVEL = 0x005D,
  Cmd_CODE_EH_SET_RULE_COUNTER = 0x005E,
  Cmd_CODE_EH_CLEAR_RULE_COUNTER = 0x005F,
  Cmd_CODE_EH_CLEAR_RULE_COUNTER_BY_EVENT = 0x0060,
  Cmd_CODE_EH_CLEAR_LOG = 0x0061,
  Cmd_CODE_EH_SET_MAX_RESPONSE_NUM = 0x0062,
  Cmd_CODE_EH_SET_MAX_CHECK_EVENT_NUM = 0x0063,
  ...
  Cmd_CODE_TF_REGISTER_TLM = 0x006D,
  Cmd_CODE_CA_SET_PAGE_FOR_TLM = 0x006E,
  Cmd_CODE_TF_SET_PAGE_FOR_TLM = 0x006F,
  Cmd_CODE_TLM_MGR_INIT = 0x0070,
  Cmd_CODE_TLM_MGR_INIT_MASTER_BC = 0x0071,
  Cmd_CODE_TLM_MGR_CLEAR_HK_TLM = 0x0072,
  Cmd_CODE_TLM_MGR_CLEAR_SYSTEM_TLM = 0x0073,
  Cmd_CODE_TLM_MGR_CLEAR_USER_TLM = 0x0074,
  Cmd_CODE_TLM_MGR_START_TLM = 0x0075,
  Cmd_CODE_TLM_MGR_STOP_TLM = 0x0076,
  Cmd_CODE_TLM_MGR_CLEAR_TLM_TL = 0x0077,
  Cmd_CODE_TLM_MGR_REGISTER_HK_TLM = 0x0078,
  Cmd_CODE_TLM_MGR_REGISTER_SYSTEM_TLM = 0x0079,
  Cmd_CODE_TLM_MGR_REGISTER_HIGH_FREQ_TLM = 0x007A,
  Cmd_CODE_TLM_MGR_REGISTER_LOW_FREQ_TLM = 0x007B,
  Cmd_CODE_DCU_ABORT_CMD = 0x007C,
  Cmd_CODE_DCU_DOWN_ABORT_FLAG = 0x007D,
  Cmd_CODE_DCU_CLEAR_LOG = 0x007E,
