...
void CA_load_cmd_table(CA_CmdInfo cmd_table[CA_MAX_CMDS])
{
  ...
  cmd_table[Cmd_CODE_BCT_ROTATE_BLOCK].param_size_infos[0].packed_info.bit.first = CA_PARAM_SIZE_TYPE_2BYTE;
  ...
  cmd_table[Cmd_CODE_BCT_TIMELIMIT_COMBINE_BLOCK].param_size_infos[0].packed_info.bit.second = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_BCT_SET_ROTATE_INTERVAL].param_size_infos[0].packed_info.bit.first = CA_PARAM_SIZE_TYPE_2BYTE;
  cmd_table[Cmd_CODE_BCT_SET_ROTATE_INTERVAL].param_size_infos[0].packed_info.bit.second = CA_PARAM_SIZE_TYPE_2BYTE;
  cmd_table[Cmd_CODE_BCT_ACTIVATE_BLOCK_BY_ID].param_size_infos[0].packed_info.bit.first = CA_PARAM_SIZE_TYPE_2BYTE;
