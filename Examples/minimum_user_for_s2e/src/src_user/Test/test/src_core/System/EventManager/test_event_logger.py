...
EL_CORE_GROUP_NULL          = 0
EL_CORE_GROUP_EVENT_LOGGER  = 1
EL_CORE_GROUP_EL_DROP_CLOG1 = 9
EL_CORE_GROUP_EL_DROP_CLOG2 = 10
EL_GROUP_TEST  = 0xf0
EL_GROUP_TEST1 = 0xf1
EL_GROUP_MAX  = 0x100
...
# 
#     # 初回のdelta時間は 0
#     assert g_clog_em_tlm["EL.CLOGS.LOG0.DELTA_RECORD_TIME.TOTAL_CYCLE"] == 0
#     assert g_clog_em_tlm["EL.CLOGS.LOG0.DELTA_RECORD_TIME.STEP"] == 0
#     last_log_time_cycle = g_clog_em_tlm["EL.CLOGS.LOG0.EVENT.TIME.TOTAL_CYCLE"]
#     last_log_time_step  = g_clog_em_tlm["EL.CLOGS.LOG0.EVENT.TIME.STEP"]
# 
...
# 
#     diff_cycle = g_clog_em_tlm["EL.CLOGS.LOG0.EVENT.TIME.TOTAL_CYCLE"] - last_log_time_cycle
#     diff_step  = g_clog_em_tlm["EL.CLOGS.LOG0.EVENT.TIME.STEP"] - last_log_time_step
# 
#     if diff_step < 0:
#         diff_step  += 100
#         diff_cycle -= 1
# 
#     assert g_clog_em_tlm["EL.CLOGS.LOG0.DELTA_RECORD_TIME.TOTAL_CYCLE"] == diff_cycle
#     assert g_clog_em_tlm["EL.CLOGS.LOG0.DELTA_RECORD_TIME.STEP"] == diff_step
# 
#     ### CLog のずらし
#     # 違うイベント
#     ret = wings.util.send_rt_cmd_and_confirm(
...
#     assert g_tlog_em_tlm["EL.TLOGS.EVENTS" + str(tlm_idx) + ".GROUP"] == group
#     assert g_tlog_em_tlm["EL.TLOGS.EVENTS" + str(tlm_idx) + ".LOCAL"] == local
#     assert g_tlog_em_tlm["EL.TLOGS.EVENTS" + str(tlm_idx) + ".NOTE"]  == note
# 
# 
...
#     update_el_clog_tlm()
# 
#     assert g_clog_em_tlm["EL.CLOGS.LOG" + str(idx) + ".EVENT.GROUP"] == group
#     assert g_clog_em_tlm["EL.CLOGS.LOG" + str(idx) + ".EVENT.LOCAL"] == local
#     assert g_clog_em_tlm["EL.CLOGS.LOG" + str(idx) + ".EVENT.NOTE"]  == note
# 
#     return g_clog_em_tlm["EL.CLOGS.LOG" + str(idx) + ".COUNT"]
# 
# 
...
#     g_tlog_count_total         = el_tlog_tlm["EL.STATISTICS.RECORD_COUNTER_TOTAL"]
#     g_tlog_count               = el_tlog_tlm["EL.STATISTICS.RECORD_COUNTERS_ERR_LEVEL"]
#     g_tlog_tlm_info            = {"page_no" : el_tlog_tlm["EL.TLM_INFO.TLOG.PAGE_NO"], "err_level" : el_tlog_tlm["EL.TLM_INFO.TLOG.ERR_LEVEL"]}
#     g_tlog_capacity            = el_tlog_tlm["EL.TLOGS.LOG_CAPACITY"]
#     g_tlog_wp                  = el_tlog_tlm["EL.TLOGS.LOG_WP"]
#     g_tlog_is_enable_overwrite = el_tlog_tlm["EL.TLOGS.IS_ENABLE_OVERWRITE"]
#     g_tlog_is_overflow         = el_tlog_tlm["EL.TLOGS.IS_TABLE_OVERFLOW"]
# 
# 
...
#     g_clog_count_total = el_clog_tlm["EL.STATISTICS.RECORD_COUNTER_TOTAL"]
#     g_clog_count       = el_clog_tlm["EL.STATISTICS.RECORD_COUNTERS_ERR_LEVEL"]
#     g_clog_tlm_info    = {"page_no" : el_clog_tlm["EL.TLM_INFO.CLOG.PAGE_NO"], "err_level" : el_clog_tlm["EL.TLM_INFO.CLOG.ERR_LEVEL"]}
#     g_clog_capacity    = el_clog_tlm["EL.CLOGS.LOG_CAPACITY"]
