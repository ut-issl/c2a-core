...
typedef enum
{
  ...
  Cmd_CODE_TLM_MGR_INIT = 0x006A,
  Cmd_CODE_TLM_MGR_INIT_MASTER_BC = 0x006B,
  Cmd_CODE_TLM_MGR_CLEAR_HK_TLM = 0x006C,
  Cmd_CODE_TLM_MGR_CLEAR_SYSTEM_TLM = 0x006D,
  Cmd_CODE_TLM_MGR_CLEAR_USER_TLM = 0x006E,
  Cmd_CODE_TLM_MGR_START_TLM = 0x006F,
  Cmd_CODE_TLM_MGR_STOP_TLM = 0x0070,
  Cmd_CODE_TLM_MGR_CLEAR_TLM_TL = 0x0071,
  Cmd_CODE_TLM_MGR_REGISTER_HK_TLM = 0x0072,
  Cmd_CODE_TLM_MGR_REGISTER_SYSTEM_TLM = 0x0073,
  Cmd_CODE_TLM_MGR_REGISTER_HIGH_FREQ_TLM = 0x0074,
  Cmd_CODE_TLM_MGR_REGISTER_LOW_FREQ_TLM = 0x0075,
  Cmd_CODE_DCU_ABORT_CMD = 0x0076,
  Cmd_CODE_DCU_DOWN_ABORT_FLAG = 0x0077,
  Cmd_CODE_DCU_CLEAR_LOG = 0x0078,
  Cmd_CODE_TEST_CCP_REGISTER_TLC_ASAP = 0x0079,
  Cmd_CODE_TEST_CCP_GET_RAW_PARAM_INFO = 0x007A,
