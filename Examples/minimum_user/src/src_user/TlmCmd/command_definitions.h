...
typedef enum
{
  ...
  Cmd_CODE_WDT_INIT = 0x0107,
  Cmd_CODE_WDT_ENABLE = 0x0108,
  Cmd_CODE_WDT_DISABLE = 0x0109,
  Cmd_CODE_WDT_STOP_CLEAR = 0x010A,
  Cmd_CODE_WDT_START_CLEAR = 0x010B,
  Cmd_CODE_UART_TEST_INIT_DI = 0x010C,
  Cmd_CODE_UART_TEST_UPDATE = 0x010D,
  Cmd_CODE_UART_TEST_SEND_TEST = 0x010E,
