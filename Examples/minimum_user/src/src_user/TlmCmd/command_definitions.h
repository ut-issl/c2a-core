...
typedef enum
{
  ...
  Cmd_CODE_TG_FOWARD_TLM = 0x001F,
  Cmd_CODE_TG_FOWARD_TLM_TO_HK_TLM = 0x0020,
  Cmd_CODE_TG_FOWARD_TLM_TO_MS_TLM = 0x0021,
  Cmd_CODE_TG_FOWARD_TLM_TO_ST_TLM = 0x0022,
  ...
  Cmd_CODE_TEST_CCP_REGISTER_TLC_ASAP = 0x0081,
  Cmd_CODE_TEST_CCP_GET_RAW_PARAM_INFO = 0x0082,
