...
typedef enum
{
  ...
  Cmd_CODE_MEM_SET_REGION = 0x0030,
  Cmd_CODE_MEM_LOAD = 0x0031,
  Cmd_CODE_MEM_SET_DESTINATION = 0x0032,
  Cmd_CODE_MEM_COPY_REGION_SEQ = 0x0033,
  ...
  Cmd_CODE_TEST_CCP_REGISTER_TLC_ASAP = 0x007D,
  Cmd_CODE_TEST_CCP_GET_RAW_PARAM_INFO = 0x007E,
