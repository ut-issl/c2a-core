...
void CA_load_cmd_table(CA_CmdInfo cmd_table[CA_MAX_CMDS])
{
  ...
  cmd_table[Cmd_CODE_TG_FOWARD_TLM].cmd_func = Cmd_TG_FOWARD_TLM;
  cmd_table[Cmd_CODE_TG_FOWARD_TLM_TO_HK_TLM].cmd_func = Cmd_TG_FOWARD_TLM_TO_HK_TLM;
  cmd_table[Cmd_CODE_TG_FOWARD_TLM_TO_MS_TLM].cmd_func = Cmd_TG_FOWARD_TLM_TO_MS_TLM;
  ...
  cmd_table[Cmd_CODE_TG_GENERATE_ST_TLM].param_size_infos[1].packed_info.bit.first = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_TG_FOWARD_TLM].param_size_infos[0].packed_info.bit.first = CA_PARAM_SIZE_TYPE_2BYTE;
  cmd_table[Cmd_CODE_TG_FOWARD_TLM].param_size_infos[0].packed_info.bit.second = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_TG_FOWARD_TLM].param_size_infos[1].packed_info.bit.first = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_TG_FOWARD_TLM].param_size_infos[1].packed_info.bit.second = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_TG_FOWARD_TLM].param_size_infos[2].packed_info.bit.first = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_TG_FOWARD_TLM_TO_HK_TLM].param_size_infos[0].packed_info.bit.first = CA_PARAM_SIZE_TYPE_2BYTE;
  cmd_table[Cmd_CODE_TG_FOWARD_TLM_TO_HK_TLM].param_size_infos[0].packed_info.bit.second = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_TG_FOWARD_TLM_TO_HK_TLM].param_size_infos[1].packed_info.bit.first = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_TG_FOWARD_TLM_TO_MS_TLM].param_size_infos[0].packed_info.bit.first = CA_PARAM_SIZE_TYPE_2BYTE;
  cmd_table[Cmd_CODE_TG_FOWARD_TLM_TO_MS_TLM].param_size_infos[0].packed_info.bit.second = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_TG_FOWARD_TLM_TO_MS_TLM].param_size_infos[1].packed_info.bit.first = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_TG_FOWARD_TLM_TO_ST_TLM].param_size_infos[0].packed_info.bit.first = CA_PARAM_SIZE_TYPE_2BYTE;
  cmd_table[Cmd_CODE_TG_FOWARD_TLM_TO_ST_TLM].param_size_infos[0].packed_info.bit.second = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_TG_FOWARD_TLM_TO_ST_TLM].param_size_infos[1].packed_info.bit.first = CA_PARAM_SIZE_TYPE_1BYTE;
  cmd_table[Cmd_CODE_TG_FOWARD_TLM_TO_ST_TLM].param_size_infos[1].packed_info.bit.second = CA_PARAM_SIZE_TYPE_1BYTE;
