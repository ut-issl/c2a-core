...
static DS_ERR_CODE AOBC_analyze_tlm_aobc_hk_(const CommonTlmPacket* packet, AOBC_TLM_CODE tlm_id, AOBC_Driver* aobc_driver)
{
  ...
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.obc_tlc_gs.counter), &(f[60]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.obc_tlc_gs.queued), &(f[64]), 1);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.obc_tlc_gs.last_exec_time), &(f[65]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.obc_tlc_gs.last_exec_id), &(f[69]), 2);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.obc_tlc_gs.last_exec_sts), &(f[71]), 1);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.obc_tlc_gs.last_err_time), &(f[72]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.obc_tlc_gs.last_err_id), &(f[76]), 2);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.obc_tlc_gs.last_err_sts), &(f[78]), 1);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.obc_tlc_gs.next_time), &(f[79]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.obc_tlc_gs.next_id), &(f[83]), 2);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.obc_tlc_bc.counter), &(f[85]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.obc_tlc_bc.queued), &(f[89]), 1);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.obc_tlc_tlm.counter), &(f[90]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.obc_tlc_tlm.queued), &(f[94]), 1);
  endian_memcpy(&temp_u8, &(f[95]), 1);
  temp_u8 >>= 7;
  temp_u8 &= 0x1;
  ...
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.obc_bct_blk_ptr), &(f[97]), 2);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.obc_bct_cmd_ptr), &(f[99]), 1);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.obc_bct_regd_time), &(f[100]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.obc_bct_regd_id), &(f[104]), 2);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.el.statistics.record_counter_total), &(f[106]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.el.statistics.record_counters_high), &(f[110]), 2);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.el.statistics.record_counters_middle), &(f[112]), 2);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.el.statistics.record_counters_low), &(f[114]), 2);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.el.statistics.record_counters_el), &(f[116]), 2);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.el.statistics.record_counters_eh), &(f[118]), 2);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.el.latest_event.group), &(f[120]), 1);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.el.latest_event.local), &(f[121]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.el.latest_event.err_level), &(f[125]), 1);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.el.latest_event.time.total_cycle), &(f[126]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.el.latest_event.time.step), &(f[130]), 1);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.el.latest_event.note), &(f[131]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.el.latest_high_event.group), &(f[135]), 1);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.el.latest_high_event.local), &(f[136]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.el.latest_high_event.time.total_cycle), &(f[140]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.el.latest_high_event.time.step), &(f[144]), 1);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.el.latest_high_event.note), &(f[145]), 2);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.eh.log_table.respond_counter), &(f[147]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.obc_gs_cmd_err_counter), &(f[151]), 1);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.git_rev_core), &(f[152]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.git_rev_user), &(f[156]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data1), &(f[160]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data2), &(f[164]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data3), &(f[168]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data4), &(f[172]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data5), &(f[176]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data6), &(f[180]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data7), &(f[184]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data8), &(f[188]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data9), &(f[192]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data10), &(f[196]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data11), &(f[200]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data12), &(f[204]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data13), &(f[208]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data14), &(f[212]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data15), &(f[216]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data16), &(f[220]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data17), &(f[224]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data18), &(f[228]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data19), &(f[232]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data20), &(f[236]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data21), &(f[240]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data22), &(f[244]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data23), &(f[248]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data24), &(f[252]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data25), &(f[256]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data26), &(f[260]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data27), &(f[264]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data28), &(f[268]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data29), &(f[272]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data30), &(f[276]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data31), &(f[280]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data32), &(f[284]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data33), &(f[288]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data34), &(f[292]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data35), &(f[296]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data36), &(f[300]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data37), &(f[304]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data38), &(f[308]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data39), &(f[312]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data40), &(f[316]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data41), &(f[320]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data42), &(f[324]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data43), &(f[328]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data44), &(f[332]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data45), &(f[336]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data46), &(f[340]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data47), &(f[344]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data48), &(f[348]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data49), &(f[352]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data50), &(f[356]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data51), &(f[360]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data52), &(f[364]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data53), &(f[368]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data54), &(f[372]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data55), &(f[376]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data56), &(f[380]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data57), &(f[384]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data58), &(f[388]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data59), &(f[392]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data60), &(f[396]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data61), &(f[400]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data62), &(f[404]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data63), &(f[408]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data64), &(f[412]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data65), &(f[416]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data66), &(f[420]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data67), &(f[424]), 4);
  endian_memcpy(&(aobc_driver->tlm_data.aobc_hk.dummy_data68), &(f[428]), 4);
  // TODO: ビットフィールドをつかっている系は，様々なパターンがあり得るので，今後，バグが出ないか注視する
